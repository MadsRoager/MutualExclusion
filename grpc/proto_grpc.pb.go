...
type RequestClient interface {
	Request(ctx context.Context, in *Priority, opts ...grpc.CallOption) (*Reply, error)
}
...
func (c *requestClient) Request(ctx context.Context, in *Priority, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/MutualExclusion.Request/request", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RequestServer interface {
	Request(context.Context, *Priority) (*Reply, error)
...
func (UnimplementedRequestServer) Request(context.Context, *Priority) (*Reply, error) {
...
func _Request_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MutualExclusion.Request/request",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RequestServer).Request(ctx, req.(*Priority))
	}
...
var Request_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "MutualExclusion.Request",
